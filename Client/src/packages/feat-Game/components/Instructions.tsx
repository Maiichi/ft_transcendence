      ...
      case "mapSelection":
        return (
          <>
            ...
            <br />- Make Your Selection: Click on a map to select it. The
            selected map will be highlighted. <br />- Submit Your Choice: Once
            you've made your selection, click 'Submit' to confirm and proceed to
            the next step.
          </>
        );
      case "inviteFriend":
        return (
          <>
            ...
            <br />
            <br />- Click the <strong>"Invite a Friend"</strong> button to
            select someone from your friend list. They will receive an
            invitation to join your game.
            <br />- Alternatively, if you prefer to play right away, select{" "}
            <strong>"Go to Matchmaking"</strong> to find a random opponent.
          </>
        );
      case "matchLoading":
        return (
          <>
            ...
            <br />
            <br />- Hang tight, this may take just a moment. Get ready to show
            off your Pong skills!
            <br />- If you wish to cancel the search, simply click the{" "}
