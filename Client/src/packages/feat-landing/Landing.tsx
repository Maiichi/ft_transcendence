          ...
          <div className="ui-layout-container">
            <div className="ui-layout-column-6 ui-layout-column-center">
              ...
              <p className="ui-text-intro">
                Experience the thrill of the fastest racket sport in the world.
                Join our platform and take your ping pong skills to the next
                level!
              </p>
          ...
          <div className="ui-layout-container">
            <div className="ui-layout-column-6 ui-layout-column-center">
              ...
              <div>
                ...
                <p>
                  Unlock achievements as you reach new milestones, proving your
              ...
              <div>
                ...
                <p>
                  Compete against players worldwide and climb to the top of the
                  global rankings.
                </p>
                <br />
              </div>
            ...
            <div className="ui-section-skills__layout ui-layout-grid ui-layout-grid-3">
              <div className="ui-component-card ui-layout-column-4">
                ...
                <p>
                  ...
                  for more personal discussions or just to chat about ping pong
                  strategies.
                </p>
              </div>
              <div className="ui-component-card ui-layout-column-4">
      ...
      <footer role="contentinfo" className="ui-section-footer">
        <div className="ui-layout-container">
          <div className="ui-section-footer__layout ui-layout-flex">
            ...
            <a href="#chat" role="link" aria-label="#" className="ui-text-note">
              <small>chat</small>
            </a>
            <a
              href="#features"
