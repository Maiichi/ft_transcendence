...
export const ChatBox: React.FC<Props> = ({
    ...
    const displayConversation = useAppSelector(
    ...
    const directConversationMessages: [] = useAppSelector(
    ...
    useEffect(() => {
        if (channelConversation !== null)
            dispatch(
                getChatRoomMessages({ token, roomId: channelConversation.id })
            );
                ...
                <div className="chatBox">
                    ...
                    <div className="chatBoxWrapper">
                        <div className="chatBoxTop">
                            {directConversationMessages.map(
                                (item: messageData) => (
                                    <>
                                        <Message
                                            own={isConnectedUser(
